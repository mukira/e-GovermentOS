...
<html lang="en">
<head>
<title>E-Nation OS — First Run</title>
<meta charset="UTF-8">
...
<section class="hero">
 <!-- Badge removed -->
 <h1>Welcome to <span class="accent">E-Nation OS</span></h1>
 <p>E-Nation OS is Kenya's sovereign digital platform. Empowering citizens with secure, AI-driven tools for governance, services, and innovation.</p>
 <div class="actions">
  </div>
</section>
...
<section>
 ...
 <div style="text-align:center;">
  <a class="btn btn-accent" href="https://bit.ly/E-Nation OS-setup">Quick start guide</a>
  <a class="btn btn-outline" href="https://github.com/e-nation-os/platform">
 ...
 <div class="grid" style="margin-top:1rem;">
  ...
  <div class="card">
   ...
   <p class="muted" style="margin-top:.35rem">Navigate to <a href="chrome://settings/enation"><code>chrome://settings/enation</code></a> to configure your own API keys for various providers.</p>
 ...
 <div class="banner" style="margin-top:1.1rem;">
  ...
  <div class="muted" style="margin-top:.4rem">Your ready to use E-Nation OS, have fun! This page can be always accessed again at <a href="chrome://enation-os-welcome"><code>chrome://enation-os-welcome</code></a></div>
 </div>
</section>
...
class NxtscapeFirstRunUIConfig : public content::DefaultWebUIConfig<NxtscapeFirstRun> {
  public:
   NxtscapeFirstRunUIConfig() : DefaultWebUIConfig("chrome", "enation-os-welcome") {}
};
