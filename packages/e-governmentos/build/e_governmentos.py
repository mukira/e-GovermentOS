#!/usr/bin/env python3
"""
e-GovernmentOS Build System - Main Entry Point

Unified CLI for building, developing, and releasing e-GovernmentOS browser.

Usage:
    # As installed command:
    e-governmentos build --help

    # As module:
    python -m build.e_governmentos build --help
"""
import typer
...
# Create main app
app = typer.Typer(
    help="e-GovernmentOS Build System",
...
app.add_typer(build_app, name="build", help="Build e-GovernmentOS browser")
