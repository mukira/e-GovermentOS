...
class CompileModule(CommandModule):
    ...
    def execute(self, ctx: Context) -> None:
        ...
        autoninja_cmd = "ninja"
        log_warning("Switching to classic Ninja to avoid Siso-induced FS corruption. Throttling to 4 jobs.")
        
        # Classic Ninja setup - reliable, robust
        os.environ["NINJA_JOBS"] = "4" # Ninja handles load better than Siso
        if "SISO_LIMITS" in os.environ: del os.environ["SISO_LIMITS"]
