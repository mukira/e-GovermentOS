diff --git a/components/metrics/e_governmentos_metrics/e_governmentos_metrics_service.h b/components/metrics/e_governmentos_metrics/e_governmentos_metrics_service.h
new file mode 100644
index 0000000000000..cb7519c887826
--- /dev/null
+++ b/components/metrics/e_governmentos_metrics/e_governmentos_metrics_service.h
@@ -0,0 +1,95 @@
...
+class e-GovernmentOSMetricsService : public KeyedService {
+ public:
+  explicit e-GovernmentOSMetricsService(
+      PrefService* pref_service,
+      PrefService* local_state_prefs,
+      scoped_refptr<network::SharedURLLoaderFactory> url_loader_factory);
+
+  e-GovernmentOSMetricsService(const e-GovernmentOSMetricsService&) = delete;
+  e-GovernmentOSMetricsService& operator=(const e-GovernmentOSMetricsService&) = delete;
+
+  ~e-GovernmentOSMetricsService() override;
+
...
+  base::WeakPtrFactory<e-GovernmentOSMetricsService> weak_factory_{this};
+};
+
+}  // namespace e_governmentos_metrics
+
