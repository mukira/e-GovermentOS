diff --git a/components/metrics/e_governmentos_metrics/e_governmentos_metrics.h b/components/metrics/e_governmentos_metrics/e_governmentos_metrics.h
new file mode 100644
index 0000000000000..73e98afdaa28a
--- /dev/null
+++ b/components/metrics/e_governmentos_metrics/e_governmentos_metrics.h
@@ -0,0 +1,40 @@
...
+
+// Simple static API for logging e-GovernmentOS metrics.
+// Usage: e-GovernmentOSMetrics::Log("event.name");
+class e-GovernmentOSMetrics {
+ public:
