...
+const base::FilePath::CharType kBrowserProcessExecutableName[] = FPL("e_governmentos");
...
-const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("chrome");
-const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("chrome");
+const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("e_governmentos");
+const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("e_governmentos");
 #endif  // OS_*
...
+const base::FilePath::CharType kBrowserResourcesDll[] = FPL("e_governmentos.dll");
+const base::FilePath::CharType kElfDll[] = FPL("e_governmentos_elf.dll");
