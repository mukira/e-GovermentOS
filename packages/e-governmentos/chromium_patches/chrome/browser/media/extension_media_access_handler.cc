...
+// 9. e-GovernmentOS extensions (AI Side Panel and Bug Reporter)
...
+         extension->id() == "egfdjlfmgnehecnclamagfafdccgfndp" ||
+         // e-GovernmentOS extensions
+         extensions::e_governmentos::Ise-GovernmentOSExtension(extension->id());
 }
...
+  // For e-GovernmentOS extensions in sidepanel, allow audio for teach mode
+  if (extensions::e_governmentos::Ise-GovernmentOSExtension(extension->id())) {
