diff --git a/chrome/browser/e_governmentos_server/e_governmentos_server_prefs.h b/chrome/browser/e_governmentos_server/e_governmentos_server_prefs.h
new file mode 100644
index 0000000000000..03719e252a15a
--- /dev/null
+++ b/chrome/browser/e_governmentos_server/e_governmentos_server_prefs.h
@@ -0,0 +1,31 @@
...
+
+// Default port values for e-GovernmentOS server (10-port spacing)
...
+
+// Preference keys for e-GovernmentOS server configuration
...
+
+// Registers e-GovernmentOS server preferences in Local State (browser-wide prefs)
