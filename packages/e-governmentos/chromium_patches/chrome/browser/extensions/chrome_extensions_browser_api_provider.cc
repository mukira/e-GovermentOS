...
+  // Browser OS API
+  registry->RegisterFunction<api::e-GovernmentOSGetAccessibilityTreeFunction>();
+  registry->RegisterFunction<api::e-GovernmentOSGetInteractiveSnapshotFunction>();
+  registry->RegisterFunction<api::e-GovernmentOSClickFunction>();
+  registry->RegisterFunction<api::e-GovernmentOSInputTextFunction>();
+  registry->RegisterFunction<api::e-GovernmentOSClearFunction>();
+  registry->RegisterFunction<api::e-GovernmentOSExecuteJavaScriptFunction>();
+
