...
+  // e-GovernmentOS prefs
+  (*s_allowlist)[prefs::ke-GovernmentOSProviders] = settings_api::PrefType::kString;
+  (*s_allowlist)[prefs::ke-GovernmentOSShowToolbarLabels] = settings_api::PrefType::kBoolean;
+  (*s_allowlist)[prefs::ke-GovernmentOSCustomProviders] = settings_api::PrefType::kString;
+
