...
+class e-GovernmentOSChangeDetector : public content::WebContentsObserver {
+ public:
...
+  explicit e-GovernmentOSChangeDetector(content::WebContents* web_contents);
+  ~e-GovernmentOSChangeDetector() override;
+
+ private:
+  e-GovernmentOSChangeDetector(const e-GovernmentOSChangeDetector&) = delete;
+  e-GovernmentOSChangeDetector& operator=(const e-GovernmentOSChangeDetector&) = delete;
+
...
+  base::WeakPtrFactory<e-GovernmentOSChangeDetector> weak_factory_{this};
+};
+
+}  // namespace api
+}  // namespace extensions
