...
+  
+  // Always force-pin e-GovernmentOS extensions that are marked pinned.
+  for (const auto& extension_id : e_governmentos::Gete-GovernmentOSExtensionIds()) {
+    if (e_governmentos::Ise-GovernmentOSPinnedExtension(extension_id)) {
