...
+  return "e_governmentos-first-run";
+}
+
...
+<html lang="en">
+<head>
+<title>e-GovernmentOS — First Run</title>
+<meta charset="UTF-8">
...
+ <p>e-GovernmentOS is an AI-powered browser that lets you build and run agents to automate tedious tasks. It looks like Chrome but reimagined for the AI era.</p>
+ <div class="actions">
+  </div>
+</section>
+
...
+  <a class="btn btn-accent" href="https://bit.ly/e-GovernmentOS-setup">Quick start guide</a>
...
+   <p class="muted" style="margin-top:.35rem">Navigate to <a href="chrome://settings/e_governmentos"><code>chrome://settings/e_governmentos</code></a> to configure your own API keys for various providers.</p>
...
+   Step 3: All done!
+  </div>
+  <div class="muted" style="margin-top:.4rem">Your ready to use e-GovernmentOS, have fun! This page can be always accessed again at <a href="chrome://e_governmentos-first-run"><code>chrome://e_governmentos-first-run</code></a></div>
+ </div>
+</section>
+
+<section>
...
+   Discord
+  </a>
+  <a href="https://github.com/e_governmentos-ai/e-GovernmentOS">
+   <span class="icon" aria-hidden="true">
+    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
+     <title>GitHub</title>
...
+   GitHub
+  </a>
+  <a href="https://x.com/eGovernmentOS_ai">
+   <span class="icon" aria-hidden="true">
+    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
+     <title>X</title>
...
+  public:
+   NxtscapeFirstRunUIConfig() : DefaultWebUIConfig("chrome", "e_governmentos-first-run") {}
+};
+
