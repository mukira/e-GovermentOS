diff --git a/chrome/browser/ui/views/side_panel/e_governmentos_simple_page_extractor.cc b/chrome/browser/ui/views/side_panel/e_governmentos_simple_page_extractor.cc
new file mode 100644
index 0000000000000..4a801a5d847ea
--- /dev/null
+++ b/chrome/browser/ui/views/side_panel/e_governmentos_simple_page_extractor.cc
@@ -0,0 +1,231 @@
+// Copyright 2025 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#include "chrome/browser/ui/views/side_panel/e_governmentos_simple_page_extractor.h"
+
+#include <algorithm>
+#include <string>
...
+
+std::u16string e-GovernmentOSSimplePageExtractor::ExtractStructuredText(
