diff --git a/chrome/browser/ui/views/side_panel/e_governmentos_simple_page_extractor.h b/chrome/browser/ui/views/side_panel/e_governmentos_simple_page_extractor.h
new file mode 100644
index 0000000000000..b9cbddf65327e
--- /dev/null
+++ b/chrome/browser/ui/views/side_panel/e_governmentos_simple_page_extractor.h
@@ -0,0 +1,71 @@
+// Copyright 2025 The Chromium Authors
+// Use of this source code is governed by a BSD-style license that can be
+// found in the LICENSE file.
+
+#ifndef CHROME_BROWSER_UI_VIEWS_SIDE_PANEL_BROWSEROS_SIMPLE_PAGE_EXTRACTOR_H_
+#define CHROME_BROWSER_UI_VIEWS_SIDE_PANEL_BROWSEROS_SIMPLE_PAGE_EXTRACTOR_H_
+
+#include <string>
+
+namespace ui {
...
+// e-GovernmentOS LLM features (LLM Chat, Clash of GPTs).
+//
...
+//         std::u16string text = side_panel::e-GovernmentOSSimplePageExtractor
+//             ::ExtractStructuredText(update);
+//         // Use extracted text...
+//       }), ...);
+//
+class e-GovernmentOSSimplePageExtractor {
+ public:
...
+  e-GovernmentOSSimplePageExtractor() = delete;
+  ~e-GovernmentOSSimplePageExtractor() = delete;
+  e-GovernmentOSSimplePageExtractor(const e-GovernmentOSSimplePageExtractor&) = delete;
+  e-GovernmentOSSimplePageExtractor& operator=(const e-GovernmentOSSimplePageExtractor&) = delete;
+};
+
+}  // namespace side_panel
+
+#endif  // CHROME_BROWSER_UI_VIEWS_SIDE_PANEL_BROWSEROS_SIMPLE_PAGE_EXTRACTOR_H_
