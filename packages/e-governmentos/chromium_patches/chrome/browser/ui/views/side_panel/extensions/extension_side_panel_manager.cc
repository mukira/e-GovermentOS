...
@@ -120,6 +123,15 @@ void ExtensionSidePanelManager::MaybeCreateActionItemForExtension(
           ...
           .Build());
+
+  // Auto-pin e-GovernmentOS extensions to the toolbar.
+  if (e_governmentos::Ise-GovernmentOSPinnedExtension(extension->id())) {
+    LOG(INFO) << "e_governmentos: Auto-pinning e-GovernmentOS extension: "
+              << extension->id();
